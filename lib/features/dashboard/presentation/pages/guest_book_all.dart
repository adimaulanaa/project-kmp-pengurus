...
import 'package:kmp_pengurus_app/features/dashboard/presentation/bloc/dashboard_bloc.dart';
import 'package:kmp_pengurus_app/features/dashboard/presentation/bloc/dashboard_event.dart';
import 'package:kmp_pengurus_app/features/dashboard/presentation/bloc/dashboard_state.dart';
...
class GuestBookScreen extends StatefulWidget {
  GuestBookScreen({Key? key}) : super(key: key);
...
class _GuestBookScreenState extends State<GuestBookScreen> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<DashboardBloc>(context).add(LoadAllGuestBook());
  }
  ...
  Widget _build(BuildContext context) {
    return BlocListener<DashboardBloc, DashboardState>(
      listener: (context, state) async {
        if (state is AllGuestBookLoading) {
          isLoading = false;
          setState(() {});
        } else if (state is AllGuestBookLoaded) {
          if (state.data != null) {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        width: MediaQuery.of(context).size.width * 0.4,
                        child: Text(listData[index].destinationPersonName!,
                            maxLines: 2,
                                                      ...
                                                      Container(
                                                        child: ktp != null
                                                            ...
                                                            : Container(
                                                                ...
                                                                child:
                                                                    Image.asset(
                                                                  "assets/images/empty_idcard.png",
                                                                ),
                                                              ),
                                                      ),
                                                      Divider(),
