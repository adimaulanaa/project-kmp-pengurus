...
class AuthLocalDataSourceImpl implements AuthLocalDataSource {
  ...
  Future<void> clearToken() async {
    ...
    await dbService.deleteData(HiveDbServices.boxCashBook);
    await dbService.deleteData(HiveDbServices.boxDeposit);
    await dbService.deleteData(HiveDbServices.boxDues);
    await dbService.deleteData(HiveDbServices.boxFinancialStatement);
    await dbService.deleteData(HiveDbServices.boxCaretaker);
    await dbService.deleteData(HiveDbServices.boxCategory);
    await dbService.deleteData(HiveDbServices.boxHouse);
    await dbService.deleteData(HiveDbServices.boxOfficer);
    await dbService.deleteData(HiveDbServices.boxSubscription);
    await dbService.deleteData(HiveDbServices.boxProfile);
    await dbService.deleteData(HiveDbServices.boxGuest);
    return;
  }
